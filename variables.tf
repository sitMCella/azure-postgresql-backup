...
variable "postgresql_administrator_login" {
  description = "(Required) The administrator username of the Azure Database for PostgreSQL Flexible Server."
  type        = string
}

variable "postgresql_administrator_password" {
  description = "(Required) The administrator password of the Azure Database for PostgreSQL Flexible Server."
  type        = string
}
